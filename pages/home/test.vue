<template>
  <view class="page">
    ...
    >
      ...
      <view class="bg-blue padding-lr-sm" style="height:120px">
        <view class="bg-white padding shadow my-style" style="height:120px">
          <view class="flex justify-between">
            <image
              class="flex-sub margin-right-sm my-face"
              lazy-load="true"
              mode="aspectFit"
              :src="store.imgUrl"
            />
      ...
      <scroll-view scroll-x class="bg-white nav" scroll-left="0">
        <view class="cu-bar search solids-top solids-bottom">
          <view class="flex align-center justify-between">
            <view
              class="cu-item"
              :class="[tabCur == index?'text-blue cur':'']"
      ...
      <view v-if="tabCur == 0">
        <view class="flex">
          ...
          >
            <view
              class="cu-item"
              :class="index==vTabCur?'text-black text-bold cur':''"
          ...
          >
            <view v-for="(item,index) in menu" :key="index" :id="'main-'+index">
              ...
              <view class="flex margin-bottom-sm" v-for="(cItem,cIndex) in item.list" :key="cIndex">
                <view class="margin-right-sm" style="width:160upx;height:160upx;overflow: hidden;">
                  <image
                    style="width:160upx;height:160upx;border-radius:10upx;"
                    mode="scaleToFill"
                    lazy-load="true"
                    :src="cItem.imgUrl"
                  />
                ...
                <view class="flexd">
                  <view>
                    ...
                    <view class="text-xs text-cut my-width">
        ...
        <scroll-view scroll-y :style="style" @scrolltolower="toLowFun">
          ...
          <view class="bg-white margin-top-sm">
            ...
            <view class="padding-top padding-lr my-tag">
              <view
                class="cu-tag radius bg-blue margin-bottom-xs"
                :class="[tagCur == index?'':'light']"
            ...
            <view>
              <view
                ...
                :key="index"
                class="flex padding-tb solid-bottom"
              >
                <view
                  style="width:80upx;height:80upx;border:1upx solid #aaaaaa;border-radius:50%; overflow: hidden;margin:0 20upx;"
                >
                  <image
                ...
                <view class="padding-right-sm" style="width:630upx;">
                  <view class="flex justify-between">
                    <view>
                  ...
                  <view
                    ...
                    style="width:470upx;flex-wrap: wrap;"
                    v-if="item.imgList"
                  >
                    <view
                      v-for="(cItem,cIndex) in item.imgList"
                      :key="cIndex"
                      style="width:150upx;height:150upx;overflow: hidden;"
                      class="margin-bottom-sm"
                    >
                      <image
                        style="width:150upx;height:150upx;border-radius:10upx;"
                        mode="scaleToFill"
                        lazy-load="true"
                        :src="cItem"
                      />
                  ...
                  <view class="my-tag">
                    ...
                    <view
                      class="cu-tag radius line-blue margin-bottom-xs"
                      v-for="(cItem,cIndex) in item.foodList"
                      :key="cIndex"
                    >{{cItem}}</view>
                  </view>
                  <view
                    v-if="item.reply"
                    class="padding-sm bg-gray text-sm text-grey"
                  >商家回复：{{item.reply}}</view>
                </view>
              </view>
            </view>
        ...
        },
        {
          ...
          list: [
            ...
            },
            {
              imgUrl: "/static/ddd.jpg",
              name: "豚骨拉面",
              introduction: "精心熬制的豚骨汤豚骨汤豚骨汤豚骨汤",
              sales: 79,
              rate: 98,
              price: 36,
              bargain: 18,
      ...
      discussList: [
        {
          ...
          content:
            "非常好，经常买，鸡肉卷鸡米花很好吃，卖家还送优惠券，还会再来，推荐推荐，棒棒哒！",
          imgList: [],
          foodList: ["鸡米花", "鸡肉卷"],
          reply:
            "今天能收到您的赞扬，以后我要先感谢领导给予的栽培！感谢公司给予我为你服务的机会！还要感谢祖国对我的培养！当然最最需要感谢的，还是您对我的认同！"
        },
        {
          name: "匿名用户",
          imgUrl: "/static/face.jpg",
