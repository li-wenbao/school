<template>
	<view class="page">
		...
		<view class="flex">
					...
					<view v-if="orderList.length>0">
						<view class="margin-sm radius padding-sm bg-white radius20" v-for="(item,index) in orderList" :key="index">
							...
							<view class="margin-top flex justify-end text-center">
								...
								<button @click="_goSetaList" class="cu-btn line-gray text-black radius20" role="button" aria-disabled="false">再来一单</button>
								<button v-if="item.status =='已取消'" class="cu-btn line-gray text-black radius20 margin-left" role="button"
				...
				<scroll-view scroll-y :style="style" @scrolltolower="toLowFun">
					<view v-if="orderList.length>0">
						<view class="margin-sm radius padding-sm bg-white radius20" v-for="(item,index) in orderList" :key="index">
							...
							<view class="margin-top flex justify-end text-center">
								<!-- <button @click="_goTelStore" class="cu-btn sm line-gray text-black radius20" role="button" aria-disabled="false">致电商家</button>
								<button @click="_goTelHorman" class="cu-btn sm line-gray text-black radius20" role="button" aria-disabled="false">致电骑手</button> -->
			...
			<!-- 待评价结束 -->
			<!-- 退款开始 -->
			<view v-if="tabCur == 2" style="margin-top:45px">
				<scroll-view scroll-y :style="style" @scrolltolower="toLowFun">
					<view v-if="orderList.length>0">
						<view class="margin-sm radius padding-sm bg-white radius20" v-for="(item,index) in orderList" :key="index">
							<view class="flex">
							...
							<view class="margin-top flex justify-end text-center">
								...
								<button @click="_goSetaList" class="cu-btn text-xs line-gray text-black text-cyan radius20" role="button" aria-disabled="false">再来一单</button>
								<button class="cu-btn text-xs line-gray text-black radius20 margin-left" role="button" aria-disabled="false" :data-id="item.orderId"
